          ...
          <div class="kt-login__signin">
            ...
            <div class="kt-login__actions text-center">
              <a
                ...
                class="btn btn-brand btn-pill kt-login__btn-primary text-light"
              >Login with 3BOT</a>
            </div>
          </div>
          <div class="kt-login__account">
            <span class="kt-login__account-msg">Don't have an account yet ?</span>
            <a :href="url" id="kt_login_signup" class="kt-login__account-link">Sign Up!</a>
          </div>
        </div>
      </div>
    </div>
